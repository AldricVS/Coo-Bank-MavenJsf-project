...
import client.AbstractOperation;
...
public class Simulation {
	...
	/**
	 * A separate method to be called after bean restreiving.
	 *
	 */
	...
	/**
	 * For each iteration of bank simulation, several things to do.
	 * 
	 * @param currentSystemTime the current system time during the simulation
	 */
	...
	private int persistSimulationResult() {
		...
		return persistence.persist(simulationEntry, statisticManager);
	}
